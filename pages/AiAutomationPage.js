...
// --- UPDATED DATA ARRAYS ---
const genAiServices = [
    { title: 'AI Automation Consulting', description: 'As a leading AI automation agency in India, we deliver strategic consulting to identify automation opportunities, define architecture, and implement scalable AI automation solutions tailored to your business use cases and objectives.', icon: 'ai-automation-consulting' },
    { title: 'Data-driven Automation', description: 'We develop data-powered AI automation services that generate insights, drive actions, and sustain operations—enabling companies to pursue intelligent automation via machine learning and real-time data processing in a secure and robust infrastructure.', icon: 'data-driven-automation' },
    { title: 'Business Process Automation', description: 'We provide AI business process automation tools that simplify repeated tasks, reduce costs, and ensure adherence – providing quicker, more intelligent operations through bespoke automation from a quality artificial intelligence automation company.', icon: 'business-process-automation' },
    { title: 'CRM Automation', description: 'We build AI-powered automation solutions that enhance CRM efficiency—automating data entry, lead scoring, and customer segmentation—empowering sales teams to focus on conversions with intelligent AI and automation solutions.', icon: 'crm-automation' },
    { title: 'AI-Powered App Development', description: 'As a full-scale AI automation company, we build intelligent, AI-driven applications that reduce human effort, automate processes, and enhance strategic decision-making, supported by our seasoned AI automation engineers and consultants.', icon: 'ai-powered-app-development' },
    { title: 'Internal AI Tools Development', description: 'Our AI automation agency services include building custom internal tools that automate reporting, task management, and decision workflows—improving productivity, reducing manual effort, and aligning with your tech stack.', icon: 'internal-ai-tools-development' }
];

const tangibleResults = [
    { title: 'Cross-Domain Automation Expertise', description: 'We provide cross-industry AI automation solutions across healthcare, finance, logistics, and SaaS—using domain-specific expertise to build compliant, scalable, high-performance systems tailored to operational and business objectives.', icon: 'cross-domain-automation-expertise' },
    { title: 'Low-Risk Implementation Frameworks', description: 'Our AI automation company follows structured, low-risk deployment models that ensure seamless integration, minimal disruption, and faster time-to-value, allowing organizations to automate confidently and ensure operational stability throughout their implementation.', icon: 'low-risk-implementation-frameworks' },
    { title: 'Dedicated Automation Engineering Teams', description: 'Every engagement is supported by a unique team of AI automation engineers, consultants, and architects, which makes end-to-end ownership possible, maintains the quality of delivery, and provides technical depth through a focus aligned to your business & infrastructure.', icon: 'dedicated-automation-engineering-teams' },
    { title: 'Strategic Automation Roadmap', description: 'We develop strategic AI automation roadmaps aligned with your enterprise goals — plotting phased rollouts, integration touchpoints, and scalability paths so that the processes can keep working efficiently, flexibly, and with business continuity for the long haul.', icon: 'strategic-automation-roadmap' }
];

const whyChooseUsGenAi = [
    { title: 'Strategic Automation Planning', description: 'We develop AI automation solutions that align directly with your business goals. Every system we design aims to produce measurable operational impact, not just technical functionality, so automation works for your growth, priorities, and long-term success.' },
    { title: 'Full-Cycle Delivery Ownership', description: 'We manage your AI automation journey from strategy and development to deployment to support. Partnering with one accountable partner means quality is constant, execution is quicker, and coordination challenges are a thing of the past.' },
    { title: 'Interoperable Tech Stack Expertise', description: 'Our leading AI automation engineers have extensive experience working across complex digital landscapes. We create intelligent systems tailored to your processes, eliminating the need for redundant software—ERP, CRM, RPA tools, or custom systems.' },
    { title: 'Modular and Scalable Architectures', description: 'We build extensible, modular automation systems designed for change. Whether expanding across departments or scaling up operations, our solutions scale with your business without requiring expensive redesigns or reworks.' },
    { title: 'Industry-Focused AI Use Cases', description: 'We leverage vertical experience across diverse sectors, such as healthcare, finance, logistics, and SaaS, to create AI automation solutions that address real operational challenges, ensuring relevance, compliance, and results from day one.' },
    { title: 'Dedicated Post-Launch Support', description: 'Our commitment continues beyond launch. Our team regularly reviews your AI automation system, assisting with updates, performance optimization, and planning to ensure it delivers long-lasting value as your business evolves.' }
];
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className={`text-4xl md:text-5xl font-bold transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
                        How We Empower Clients with End-to-End AI Solutions
                    </h2>
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
                        At Alpixn Technologies, we specialize in embedding AI into the fabric of business operations—speeding up processes, cutting down waste, and helping knowledge workers make better decisions. Our solution is meticulously designed with precision to align with your workflows and scale as your business grows.
                    </p>
                </div>
    ...
    <div ref={ref} className="py-24 bg-black">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className={`text-4xl md:text-5xl font-bold transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
            Key Benefits of Our AI Automation Approach
          </h2>
          <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
            Unlike agencies that push generic platforms, we provide custom AI automation services tailored to your unique challenges. We address operational inefficiencies by bridging strategic consulting, technical capabilities, and real-world implementation, maximizing time-to-value and reducing risk for long-term impact.
          </p>
          <div className="mt-8">
             <button className="bg-blue-500 text-white font-bold py-3 px-6 rounded-full hover:bg-blue-600 transition duration-300">Want to Speak to Our Solution Experts?</button>
          </div>
        </div>
    ...
    <div ref={ref} className="py-24 bg-black">
      <div className="w-full px-4 sm:px-6 lg:px-8 text-center">
        <h2 className={`text-4xl md:text-5xl font-bold mb-4 transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
            Why Choose Us for AI Automation Services
        </h2>
        <p className={`max-w-3xl mx-auto text-lg text-gray-400 mb-16 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
            Our AI automation services are built for outcomes. We bring together strategic consulting, technical execution, and post-launch support, resulting in proven automation that delivers cost savings, operational accuracy, and faster time-to-value.
        </p>
        ...
        <div ref={ref} className="py-24 bg-gray-900/50">
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
                        From regulated sectors like healthcare and finance to fast-moving industries like retail and logistics, our AI automation company provides secure, compliant, performance-driven solutions that minimize operational risk and power up digital transformation.
                    </p>
                </div>
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className={`text-4xl md:text-5xl font-bold transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>See what our clients have to say</h2>
                     <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
                        Clients appreciate our AI automation company’s clear communication, expert delivery, and business-first approach. Their experiences demonstrate how efficiently our AI and automation solutions drive operational enhancements in the organization.
                    </p>
                </div>
        ...
        <div ref={ref} className="py-24 bg-black">
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
                        Our AI automation services are built on a flexible tech stack that enables custom development, integration, and cross-platform deployment — all supported by frameworks proven to deliver speed, reliability, and value to your business over time.
                    </p>
                </div>
    ...
    const models = [
        {
            ...
            description: 'Ideal for long-term partnerships, our offshore dedicated team model provides you with full-time access to seasoned AI automation engineers who work exclusively on your project, exactly like an in-house team but at absolutely no overhead.',
        ...
        },
        {
            ...
            description: 'Best suited for companies with clear goals and timelines, our project-based model delivers end-to-end AI automation solutions from the planning stage to deployment, on a fixed budget, with full accountability and milestone-oriented progress tracking.',
            points: ['Tailored Expertise', 'Seamless Integration', 'Cost-effective Solution', 'Transparent Communication'],
            icon: 'staff-augmentation'
        },
        {
            title: 'Project-Based',
            description: 'Our project-based delivery model suits companies with clearly defined objectives and timelines for deploying a complete AI automation solution, from planning to deployment, on a fixed budget with full accountability.',
...
const FaqSection = () => {
    ...
    const faqs = [
        { q: 'What services does Alpixn Technologies offer as an AI automation agency?', a: 'Alpixn Technologies is an end-to-end AI automation service provider specializing in process automation, intelligent data processing, chatbots, machine learning integration, and AI automation consulting. As a full-service AI automation agency, we help businesses automate manual tasks, improve workflows, and scale faster with innovative technology.' },
        { q: 'How can partnering with an artificial intelligence automation agency benefit my business?', a: 'Content for this answer is not available yet.' },
        { q: 'What industries does Alpixn Technologies serve with its AI automation solutions?', a: 'Content for this answer is not available yet.' },
        { q: 'What is the process for implementing AI automation solutions with your company?', a: 'Content for this answer is not available yet.' },
        { q: 'Do you offer AI automation consulting services for businesses new to AI?', a: 'Content for this answer is not available yet.' },
        { q: 'Can Alpixn Technologies customize AI automation solutions to fit our existing systems?', a: 'Content for this answer is not available yet.' },
        { q: 'What distinguishes Alpixn Technologies from other AI automation companies?', a: 'Content for this answer is not available yet.' },
        { q: 'How does AI business process automation improve operational efficiency?', a: 'Content for this answer is not available yet.' },
        { q: 'What support can we expect after implementing AI automation solutions?', a: 'Content for this answer is not available yet.' },
        { q: 'How can we get started with Alpixn Technologies\' AI automation agency services?', a: 'Content for this answer is not available yet.' }
    ];
    ...
    return (
        <section className="bg-gray-900 py-20 px-4 sm:px-6 lg:px-8">
            <div className="container mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Connect With Intelligent Automation Experts</h2>
                <p className="text-lg mb-8 max-w-3xl mx-auto text-gray-400">Get more done with less effort. We build AI-driven automation that accelerates results and sharpens your competitive edge.</p>
      ...
      <main>
        ...
        >
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row items-center">
                ...
                >
                <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">AI Automation Agency & Consulting Services</h1>
                <p className="text-lg md:text-xl mb-6">
                    Businesses today need more than automation—they need smart systems that adapt, integrate fast, and drive real outcomes. At Alpixn Technologies, we build AI-powered automation solutions that reduce friction, boost accuracy, and empower your workforce to drive business value.
                </p>
                <motion.button
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto text-center">
            ...
            >
              From back-office operations to front-end automation, we build AI automation solutions that reduce human workload and guarantee compliance while speeding up the process, all in alignment with your business goals and technology ecosystem.
            </motion.p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <section className="bg-blue-600 py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto text-center">
            <motion.h2
              ...
              transition={{ duration: 0.5 }}
            >
              Ready to Elevate Your Operations with AI Automation?
            </motion.h2>
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Transform bottlenecks into growth opportunities with our AI automation solutions. From strategy to execution, we deliver future-ready systems that scale with your business.
            </motion.p>
            <motion.button
        ...
        <section className="py-20 bg-black text-center">
            ...
            <p className="max-w-4xl mx-auto text-gray-400 mb-10">
                Trusted by startups, enterprises, and global teams, our AI automation agency delivers reliable, scalable AI automation solutions that seamlessly streamline operations and reduce costs in all operations.
            </p>
