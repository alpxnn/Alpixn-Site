  ...
  return (
    <div className="App bg-black">
      ...
      <MainContent 
        ...
        description='"From concept to launch, we deliver tailored software that drives results."'
        buttonText="Start Your Project"
      />
      <Services 
        title="Our Software Development Services"
        description="We offer a comprehensive suite of services to bring your vision to life."
        servicesData={softwareDevServices}
      />
      <ContactForm />
      <WorkMatery 
